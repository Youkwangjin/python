# 로지스틱 클래스 사용 - 다항분류(활성화 함수) - iris dataset
...
'''
# scaling(크기를 고르게) - feature에 대해 표준화, 정규화 : 최적화 과정에서 안정성, 수렴 속도를 향상을 시킨다는 장점이 있다., 오버피팅 or 언더피팅 방지 기능도 있다.
print(x_train[:3])
sc = StandardScaler()
sc.fit(x_train)
sc.fit(x_test)
...
print('분류 정확도 확인 3')
print('test로 정확도는 ', model.score(x_test, y_test))         # test로 정확도는  0.9777777777777777
print('train으로 정확도는 ', model.score(x_train, y_train))    # train으로 정확도는  0.9714285714285714

# 모델 성능이 만족스러운 경우 모델을 저장 후
import joblib
...
# [[9.96150873e-05 8.40157413e-02 9.15884644e-01]
#  [9.98951014e-01 1.04898526e-03 4.23982562e-10]
#  [1.45281524e-09 1.56491073e-05 9.99984349e-01]
#  [8.75577236e-09 6.94416138e-03 9.93055830e-01]]
