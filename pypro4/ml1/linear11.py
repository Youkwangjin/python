...
# print('model_r2 : ', model_r2)  # 0.54414629
...
# degree = 2
model.fit(x_quad,y)
y_quad_fit = model.predict(quad.fit_transform(x_fit))    # 차트 작성용 끝
quad_r2 = r2_score(y, model.predict(x_quad))
print('quard_r2 : ', quad_r2)

# degree = 3
model.fit(x_cubic,y)
y_cubic_fit = model.predict(cubic.fit_transform(x_fit))    # 차트 작성용 끝
