...
# 판정: p-value : 0.84505 > 0.05 귀무가설 채택.  두 가지 교육 방법에 따른 평균 시험 점수에 차이가 없다.
...
# print('정규성을 만족한 경우 : ', stats.wilcoxon(score1, score2).pvalue)
print('정규성을 만족하지 못한 경우 : ', stats.mannwhitneyu(score1, score2).pvalue)
