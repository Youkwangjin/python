...
data1 = pd.read_csv("../testdata/smoke.csv")
print(data1.head(3), data1.shape)  # 355, 2
print(data1['education'].unique())  # [1 2 3]
print(data1['smoking'].unique())    # [1 2 3]
...
# 판정 : p:0.0008182 < 0.05 이기 때문에 유의한 수준(a=0.05)에서 귀무가설을 기각한다.
